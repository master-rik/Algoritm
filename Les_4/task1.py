...
"""
вывод:
1. зависимости лийнейные
2. самая быстрая произовительность оказалась в варианте №3,
далее вариант №1 и самый медленный в варианте №2 хотя вариант
№1 был сделан через рекурсию и использовал 46 стеков
скольку мой пример к сожалению оказался слишком простым нам
cProfile мало чем помогла.
"""
